...
def test_remove_expense_reduces_total():
    ...
    service.create_expense("Libro", 10, "Librería", date.today())
    service.create_expense("Revista", 5, "Kiosco", date.today())
...
def test_total_amount_after_removal():
    ...
    service.create_expense("Cursos", 30, "Educación", date.today())
    service.create_expense("Internet", 25, "Servicios", date.today())
